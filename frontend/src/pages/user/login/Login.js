...
const Login = ({authenticated}) => {
    ...
    return (
        <div className="login-container bg-indigo-100 h-screen">
            <div className="login-content bg-gray-900">
                <h1 className="login-title">Power World</h1>
                {/* <SocialLogin/> */}
                <div className="or-separator">
                    <span className="or-text bg-gray-600"></span>
                </div>
                <LoginForm/>
